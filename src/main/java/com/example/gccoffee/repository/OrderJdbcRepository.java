...
public class OrderJdbcRepository implements OrderRepository{
	...
	public Order insert(Order order) {
		...
		"VALUES (UNHEX(REPLACE(:productId, '-', '')), :email, :address, :postcode, :oderStatus, :createdAt, :updatedAt)",
			toOrderParamMap(order));
		order.getOrderItems()
			.forEach(
				item ->
					jdbcTemplate.update("INSERT INTO order_items(order_id, product_id, category, price, quantity, createdAt, updatedAt) " +
						"VALUES (UNHEX(REPLACE(:orderId, '-', '')), :productId, :category, :price, :quantity, :createdAt, :updatedAt)",
